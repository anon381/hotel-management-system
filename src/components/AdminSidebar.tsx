  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-border/30 space-y-3">
        ...
        <button
          onClick={() => { localStorage.removeItem("token"); localStorage.removeItem("user"); navigate("/login/admin"); }}
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed left-4 top-4 bottom-4 w-[260px] bg-background/95 backdrop-blur-xl border border-border/30 z-50 shadow-2xl rounded-2xl"
            >
              {sidebarContent}
            </motion.aside>
          </>
