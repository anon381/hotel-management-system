  ...
  const content = (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-border/30 space-y-3">
        ...
        <button onClick={() => { localStorage.removeItem("token"); localStorage.removeItem("user"); navigate("/login/customer"); }} className="flex items-center justify-center gap-2 w-full py-2 rounded-lg text-muted-foreground hover:text-destructive hover:bg-muted/50 transition-colors text-sm">
