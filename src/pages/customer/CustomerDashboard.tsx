...
import { UtensilsCrossed, ShoppingCart, Clock, Star, ArrowRight, Heart, Gift } from "lucide-react";
        ...
        >
          ...
          <Link to="/customer/orders">
            <motion.button
              ...
              className="mt-4 w-full py-2.5 rounded-lg border border-border text-sm font-semibold text-foreground hover:bg-muted/50 transition-colors"
            >
